...
Снимок актуализирован 2026-07-20 после публикации `v0.4.0`. Статус `done` означает, что
...
| REL-002 | P1 | ready | macOS/Linux/Windows integration E2E с temp HOME | INT-010 | Install/status/update/uninstall не зависят от реального HOME и не трогают пользовательские файлы |
